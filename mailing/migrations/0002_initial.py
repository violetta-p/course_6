...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='client',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mailing.client', verbose_name='Client'),
        ),
        migrations.AddField(
            model_name='mailinglogs',
            name='mail_settings',
        ...
        migrations.AddField(
            model_name='mailing',
            name='client',
            field=models.ManyToManyField(blank=True, to='mailing.client', verbose_name='Client'),
        ),
        migrations.AddField(
            model_name='mailing',
            name='creator',
